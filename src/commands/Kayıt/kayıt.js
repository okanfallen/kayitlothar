...
`)
    ...
    collector.on("collect", async (button) => {
      ...
      if(button.customId === "erkek") {
        ...
        client.channels.cache.get(config.channels.chat).send(` ${member} kullanıcısı sunucumuza kayıt oldu ona **Merhaba** diyelim!`).then((e) => setTimeout(() => { e.delete(); }, 15000));
