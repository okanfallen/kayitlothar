...
module.exports = async function(oldUser, newUser) {
    ...
    const ownerr = client.users.cache.get("325339036971696128");
    ...
    const embed = new MessageEmbed().setTimestamp().setFooter(`Sunucumuz da toplam ${taglıüye} taglı var.`, ownerr.avatarURL({ dynamic: true })).setAuthor(" " + newUser.username + " ", )
